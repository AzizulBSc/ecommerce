        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="text-slid-box">
                        <div id="offer-box" class="carouselTicker">
                            <ul class="offer-box">
                                <li>
                                    <i class="fa fa-opencart" aria-hidden="true"></i> Off 10%! Shop Now Man
                                </li>
                                <li>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="our-link">
                        <ul>
                            <li><a href=""><i class="fab fa-cart-plus"></i>Cart</a></li>
                            <li><a href="{{route('login')}}"><i class="fas fa-user"></i>AdminLogin</a></li>
                            <li><a href="{{url('/login-register')}}"><i class="fas fa-user"></i>CustomerLogin</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{url('/')}}"><img src="{{asset('frontend/images/logo.png')}}" class="logo" alt="brand logo"></a>
                </div>
