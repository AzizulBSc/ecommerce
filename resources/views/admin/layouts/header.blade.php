<header class="main-header">
    <a href="index.html" class="logo">
        ...
        <span class="logo-mini">
            <img src="admin/dist/img/mini-logo.png" alt="">
        </span>
        <span class="logo-lg">
                            ...
                            <ul class="menu">
                                <li>
                                    ...
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="admin/dist/img/basketball-jersey.png" class="img-thumbnail"
                                                alt="User Image">
                                        </div>
                                        <h4>polo shirt</h4>
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="admin/dist/img/shirt.png" class="img-thumbnail" alt="User Image">
                                        </div>
                                        <h4>Kits</h4>
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="admin/dist/img/football.png" class="img-thumbnail"
                                                alt="User Image">
                                        </div>
                                        <h4>Football</h4>
                                ...
                                <li class="nav-list">
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="admin/dist/img/shoe.png" class="img-thumbnail" alt="User Image">
                                        </div>
                                        <h4>Sports sheos</h4>
                        ...
                        <li>
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="admin/dist/img/avatar3.png" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>Modric</h4>
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="admin/dist/img/avatar4.png" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>Salman</h4>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="{{ route('logout') }}" onclick="event.preventDefault();
                                ...
                                <i class="fa fa-sign-out log-out"></i>Sign Out</a>
